...
const createAmountBasedSavingsGoal = async (savingsGoalInfo) => {
  const response = await instance.post("/SavingsGoal/create-amount-based", savingsGoalInfo);
  return response.data;
};

// Create a time-based savings goal
const createTimeBasedSavingsGoal = async (savingsGoalInfo) => {
  const response = await instance.post("/SavingsGoal/create-time-based", savingsGoalInfo);
  return response.data;
};
